...
> 蒸発するので厳守。完了したら ✅ か削除で反映。（旧「アクティブ運用ルール」＝`corpus-active.md` は高速反復中に形骸化したため
