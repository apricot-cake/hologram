...
export const LogoEndCard: React.FC<{ entrance: 'slide' | 'fill' }> = ({ entrance }) => {
  ...
  const wordReveal = interpolate(frame, [WORD_START, WORD_START + WORD_DUR], [0, 1], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp',
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: BG }}>
      ...
      >
        <LiquidSquare size={SQUARE} time={time} fill={fill} cornerRadius={SQUARE * 0.06} />
      </div>
