...
function register(ctx) {
  const {
    getSaveFolder, readConfig, writeConfig, readSavePointer, getConfigLastCorrupt,
    clearAllBlockReason, VIEWABLE_EXTS, fetchStillImage, pixivRefererFor,
    getWin, send, validateSaveFolder, copyLibraryInto, watchSaveFolder, resetDelta,
  } = ctx;
