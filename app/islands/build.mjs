...
const ISLANDS = ['settings', 'query-chips', 'tabs', 'collections', 'searchbox', 'posters', 'lightbox', 'toolbar', 'context-menu', 'kind-menu', 'filter-popover', 'qf-pop', 'inspector', 'edit-overlay', 'grid', 'image-tab'];
