...
// module is the single owner. Plain IIFE on window (like query.js / users.js);
// loaded BEFORE viewer.js; touches no DOM (containers are measured by the
// caller and passed in as metrics). CommonJS-exported for the pure unit test.
(function () {
  'use strict';
