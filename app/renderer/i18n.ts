...
const MESSAGES: { ja: CorpusMessageTable; en: CorpusMessageTable } = {
  ja: {
    ...
    clipTitle: 'クリップ',
    clipEmpty: '空にする',
    clipEmptyTip: 'クリップをすべて外す',
    clipRowTip: 'あとで見返したい投稿につける目印。クリックすると、クリップした投稿だけに絞り込みます。',
  ...
  en: {
    ...
    clipTitle: 'Clipped',
    clipEmpty: 'Clear',
    clipEmptyTip: 'Remove all clips',
    clipRowTip: 'A marker for posts you want to revisit. Click to show only clipped posts.',
    ...
    tagSelectedTitle: 'Add tags to the selected posts',
    sbViewTitle: 'View',
    ...
    tipAdoptTag: 'Click to add as a tag',
