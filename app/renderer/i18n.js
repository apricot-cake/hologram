...
(function () {
  const MESSAGES = {
    ja: {
      ...
      twKindMedia: 'メディア',
      twKindPlain: 'ポスト',
      twKindHelpMedia: 'メディア＝イラストや画像そのものを集めたい投稿。',
      twKindHelpPost: 'ポスト＝投稿の中身（ネタ・情報・魚拓）を残したい投稿。画像があってもこちら。',
      twKindHelpNote: '※ この区別はあとで絞り込みに使えます（保存方法は同じ）。',
    ...
    en: {
      ...
      twProgress: '$1 / $2',
      twKindQ: 'What is this?',
      twKindMedia: 'Media',
      twKindPlain: 'Post',
      twKindHelpMedia: 'Media = saved for the artwork/image itself.',
      twKindHelpPost: 'Post = saved for the post itself (a joke, info, a record) — even if it has an image.',
      twKindHelpNote: 'Note: this only affects filtering later; both save the same way.',
