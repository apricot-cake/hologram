...
(function () {
  const MESSAGES = {
    ja: {
      ...
      saveFolderChange: '変更',
      saveFolderHint: '投稿の保存場所。変更すると既存のライブラリを新しいフォルダへ移動します（移動が完了するまで元データを保持＝安全）。',
    ...
    en: {
      ...
      saveFolderHint: 'Where posts are stored. Changing it moves the existing library to the new folder (your data is kept until the move completes).',
