...
(function () {
  const MESSAGES = {
    ...
    en: {
      ...
      twNoGroups: 'No tag groups yet. Use the 未分類 step to add tags while creating a new group.',
      twNoGroup: 'No group',
      twNewGroup: '+ New group…',
      twNewGroupName: 'Group name',
      twHidden: 'Hidden',
      twShownTitle: 'Groups shown in the wizard',
      twHide: 'Hide this group from the wizard',
