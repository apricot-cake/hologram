...
(function () {
  const MESSAGES = {
    ja: {
      ...
      qbOptAll: 'すべて',
      qbOptAny: 'どれか',
      qbOptAllTip: 'すべて含む投稿だけに絞る',
      qbOptAnyTip: 'どれか1つでも含む投稿を表示',
      qbExclLabel: '除く',
      qbMenuExclude: '「除く」へ移す（〜でない）',
      qbMenuInclude: '含む条件に戻す',
      qbSummaryTip: '以前の形式の絞り込みです。編集するには「リセット」で作り直してください。',
      ...
      sbCollectionsTitle: 'コレクション',
      collManageLink: '管理',
      collSidebarEmpty: 'まだありません。「管理」で作成できます。',
      collOpen: '開く',
      collRename: '名前を変更',
    ...
    en: {
      ...
      qbSummaryTip: 'A filter saved in the old format. Press Reset to rebuild it.',
      ...
      sbCollectionsTitle: 'Collections',
      collManageLink: 'Manage',
      collSidebarEmpty: 'None yet. Create one via “Manage”.',
      collOpen: 'Open',
      collRename: 'Rename',
