...
(function () {
  const MESSAGES = {
    ja: {
      ...
      sbSortTitle: '並び順',
      sbViewTitle: '表示',
      tipTagCycle: 'クリックで切替: いずれか → ＋すべて含む → 解除（混在可）',
      sbFilterTip: '一覧を絞り込む',
      engParticle: 'が',
      ...
      qbHelp5: 'タグ・フォルダのチップはクリックで「いずれか → ＋すべて含む → 解除」の3段階',
      tagGroupsTitle: 'グループ',
    ...
    en: {
      ...
      sbSortTitle: 'Sort',
      sbViewTitle: 'View',
      tipTagCycle: 'Click to cycle: any → ＋must include → off (mixable)',
      ...
      qbHelp5: 'Tag/folder chips cycle: any → ＋must include → off',
