...
setExtensionId: (id) => ipcRenderer.invoke('set-extension-id', id),
  ...
  setTagTypes: (types, labels) => ipcRenderer.invoke('set-tag-types', types, labels),
  ...
  getPosterTags: () => ipcRenderer.invoke('get-poster-tags'),
  setPosterTags: (data) => ipcRenderer.invoke('set-poster-tags', data),
  ...
  setCollections: (data) => ipcRenderer.invoke('set-collections', data),
  ...
  onSaveFolderProgress: (cb) => ipcRenderer.on('save-folder-progress', (_e, p) => cb(p)),
