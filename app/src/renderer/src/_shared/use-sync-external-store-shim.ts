// ESM stand-in for the CJS 'use-sync-external-store' shim package (a @base-ui/react
// + @base-ui/utils transitive dep). React 18+ ships useSyncExternalStore natively,
