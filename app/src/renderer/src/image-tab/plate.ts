...
// the inspector toggle, the うごイラ play button. One translucent, blurred plate for all
...
// フォト / Eagle / IrfanView) gives the control a definite boundary for the same reason.
//
