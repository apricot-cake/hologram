...
// Pure unit test for tags.ts — the 8th viewer.js extraction slice. tags.ts is a
// real ES module (named exports), loaded via dynamic import(), driving
// tagKindOf/kindLabel (custom-label fallback), posterTagsOf/posterFilterVocab
// (kind-ranked ordering), groupedTagVocab (kind sections, post vs poster general
// pools, query filtering), inspectorTagPickerData (vocab shape, source hashtags,
// cooc suggestion tiers) and sameTags with stub deps.
//
//   node scripts/test-tags-unit.cts
