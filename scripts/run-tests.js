...
const TESTS = ['test-index', 'test-search-unit', 'test-token-parity', 'test-contrast-parity', 'test-i18n-parity', 'test-parse-url', 'test-bridge-ssrf', 'test-archive-zipslip', 'test-archive-zipbomb'];
