...
// the Claude Design shader in app/src/renderer/src/services/about-icon.ts). It is inherently raster,
...
const TARGETS = [
  ...
  { file: 'extension/public/icons/icon128.png', size: 128 }, // manifest max — Chrome ignores larger (verified against Chrome's extension icons docs)
