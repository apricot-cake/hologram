...
// Unit tests for tab-state.js (window.corpusTabState). CommonJS-exported like
// records.js/users.js, so plain require works. Covers the four extracted areas:
// makeTabLabels (filterLabel/tabTitleOf), makeNavHistory (push/back/forward/
// adopt/saveInto), serializeTabs, and sanitizeSavedTabs.
//
//   node scripts/test-tabstate-unit.js
