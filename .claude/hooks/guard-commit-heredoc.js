    ...
    process.stdout.write(
      JSON.stringify({
        hookSpecificOutput: {
          ...
          permissionDecisionReason: "Bash ツールに PowerShell の here-string (@'...'@) は使えません。POSIX sh が解釈して先頭に @ が漏れます。複数行のコミットメッセージは PowerShell ツールで @'...'@ を使うか、Write でメッセージファイルを書いて git commit -F <ファイル> を使ってください。",
        },
      }),
    );
  }
